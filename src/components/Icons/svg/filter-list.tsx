...
export function FilterList({ fill = "#1D1D1D", ...props }: SVGAttributes<SVGSVGElement>) {
  return (
    <>
        <svg width="18px" height="12px" viewBox="0 0 18 12" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props}>
